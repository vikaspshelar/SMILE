 ...
 * alphabet specified in TS 23.038 6.2.1 and UTF-16
 *
 * {
 *
 * @hide}
...
public class GsmAlphabet {
    ...
    /**
     * User data header requires one octet for length. Count as one septet,
     * because all combinations of header elements below will have at least one
     * free bit when padding to the nearest septet boundary.
     */
     ...
     * @param languageTable the 7 bit language table, or 0 for the default GSM
     * alphabet
     * @param shiftTable the 7 bit single shift language table, or 0 for the
     * default GSM extension table
     * @return String representation or null on decoding exception
     */
    public static String gsm7BitPackedToString(byte[] pdu, int offset,
...
//            Rlog.e(TAG, "Error GSM 7 bit packed: ", ex);
    ...
    /**
     * GSM default 7 bit alphabet plus national language locking shift character
     * tables. Comment lines above strings indicate the lower four bits of the
     * table position.
     */
    ...
    /**
     * GSM default extension table plus national language single shift character
     * tables.
     */
