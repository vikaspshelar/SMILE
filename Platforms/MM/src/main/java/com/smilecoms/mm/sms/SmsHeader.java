...
import com.smilecoms.mm.utils.HexDump;
...
public class SmsHeader {
    ...
    /**
     * SMS user data header information element identifiers. (see TS 23.040
     * 9.2.3.24)
     */
    ...
    /**
     * A header element that is not explicitly parsed, meaning not PortAddrs or
     * ConcatRef.
     */
    ...
    /**
     * 7 bit national language locking shift table, or 0 for GSM default 7 bit
     * alphabet.
     */
    public int languageTable;
    /**
     * 7 bit national language single shift table, or 0 for GSM default 7 bit
     * extension table.
     */
    ...
    /**
     * Create structured SmsHeader object from serialized byte array
     * representation. (see TS 23.040 9.2.3.24)
     *
    ...
    public static SmsHeader fromByteArray(byte[] data) {
        ...
        while (inStream.available() > 0) {
            /**
             * NOTE: as defined in the spec, ConcatRef and PortAddr fields
             * should not reoccur, but if they do the last occurrence is to be
             * used. Also, for ConcatRef elements, if the count is zero,
             * sequence is zero, or sequence is larger than count, the entire
    ...
    /**
     * Create serialized byte array representation from structured SmsHeader
     * object. (see TS 23.040 9.2.3.24)
     *
