...
@NamedQueries({
    ...
    @NamedQuery(name = "UnitCreditSpecification.findByUnitCreditSpecificationId", query = "SELECT u FROM UnitCreditSpecification u WHERE u.unitCreditSpecificationId = :unitCreditSpecificationId"),
    @NamedQuery(name = "UnitCreditSpecification.findByUnitCreditName", query = "SELECT u FROM UnitCreditSpecification u WHERE u.unitCreditName = :unitCreditName"),
    @NamedQuery(name = "UnitCreditSpecification.findByUnitCreditDescription", query = "SELECT u FROM UnitCreditSpecification u WHERE u.unitCreditDescription = :unitCreditDescription"),
    @NamedQuery(name = "UnitCreditSpecification.findByPriceCents", query = "SELECT u FROM UnitCreditSpecification u WHERE u.priceCents = :priceCents"),
    @NamedQuery(name = "UnitCreditSpecification.findByAvailableFrom", query = "SELECT u FROM UnitCreditSpecification u WHERE u.availableFrom = :availableFrom"),
    @NamedQuery(name = "UnitCreditSpecification.findByAvailableTo", query = "SELECT u FROM UnitCreditSpecification u WHERE u.availableTo = :availableTo"),
    @NamedQuery(name = "UnitCreditSpecification.findByValidityDays", query = "SELECT u FROM UnitCreditSpecification u WHERE u.validityDays = :validityDays"),
    @NamedQuery(name = "UnitCreditSpecification.findByUnits", query = "SELECT u FROM UnitCreditSpecification u WHERE u.units = :units")})
public class UnitCreditSpecification implements Serializable {
    ...
    public String toString() {
        return "com.smilecoms.cm.db.model.UnitCreditSpecification[ unitCreditSpecificationId=" + unitCreditSpecificationId + " ]";
    }
}
