...
public class CustomerProfile implements Serializable {
    ...
    @Column(name = "IS_NIN_VERIFIED")
    private String isNinVerified;
    @Basic(optional = false)
    @NotNull
    ...
    public String getIsNinVerified() {
        return isNinVerified;
    }

    public void setIsNinVerified(String isNinVerified) {
        this.isNinVerified = isNinVerified;
    }
