 ...
 * @author paul
 */
public class MidnightAndWeekendFilterClass extends AllowBasedOnServiceCodeAndRatingGroupFilterClass {

    private static final Logger log = LoggerFactory.getLogger(MidnightAndWeekendFilterClass.class);
