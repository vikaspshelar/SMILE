 ...
 * @author paul
 */
public class NightAndWeekendFilterClass extends AllowBasedOnServiceCodeAndRatingGroupFilterClass {

    private static final Logger log = LoggerFactory.getLogger(NightAndWeekendFilterClass.class);
