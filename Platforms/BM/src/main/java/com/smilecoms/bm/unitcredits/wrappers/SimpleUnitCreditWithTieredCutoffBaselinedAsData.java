 ...
 * @author paul
 */
public class SimpleUnitCreditWithTieredCutoffBaselinedAsData extends SimpleUnitCreditWithTieredCutoff {

    private static final Logger log = LoggerFactory.getLogger(SimpleUnitCreditWithTieredCutoffBaselinedAsData.class);
