            ...
            <stripes:form action="/Customer.action" focus="" autocomplete="off" onsubmit="return alertValidationErrors();">   
                <c:choose>
                    ...
                    <c:otherwise>
                        <div> 
                            <table class="clear">                       
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${(sessionScope.sessionSale != null || sessionScope.sessionAddProduct != null) && sessionScope.customerNIN != null}" > 
                                                <stripes:text name="customer.nationalIdentityNumber"  id="customer.nationalIdentityNumber" value="${sessionScope.customerNIN}" readonly="true" size="20" maxlength="11" onkeypress="return isNumberKey(event)" onkeyup="validate(this,'^.{11,11}$','')"/>
                                            </c:when>
                                            <c:otherwise>    
                        ...
                        <span class="button">
                            <stripes:submit name="retrieveCustomerDetailsForKyc"/>
                        </span>
                    </c:otherwise>
                </c:choose>
            </stripes:form>
            <c:choose>
                <c:when test="${actionBean.ninVerified}">
                    <stripes:form action="/Customer.action">
                        <input type="hidden" id="datasrc" name="datasrc" value="nimc"/> 
                        
                        <c:if test="${sessionScope.sessionSale != null}" >                            
                            <input type="hidden" id="processType" name="processType" value="newsim"/>
                        </c:if>
                        <c:if test="${sessionScope.sessionAddProduct != null}" >
                            <input type="hidden" id="processType" name="processType" value="addsim"/>
                        </c:if>    
                        <c:if test="${sessionScope.sessionAddProduct == null && sessionScope.sessionSale == null}">
