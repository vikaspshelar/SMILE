...
<stripes:layout-render name="/layout/standard.jsp" title="${title}">
        ...
        <script type="text/javascript">
            ...
            $j(document).ready(function () { /*visaexpirydate*/
                $j('#datePicker3').datepicker({
                    ...
                    beforeShow: function( input ) {showForLifeButton(input);},
                    onChangeMonthYear: function (yy, mm, inst) {showForLifeButton(inst.input);}
                    });
            });
    ...
    <stripes:layout-component name="contents">        
            ...
            <stripes:form action="/Customer.action" focus="" id="form_edit" autocomplete="off" method="POST" onsubmit="enableNiraSuppliedFields(); return (alertValidationErrors() && checkRequiredDocuments());">    
                ...
                <stripes:select readonly="true" name="customer.foreign.id.document.types"  id="customer.foreign.document.id.types" style="display:none">
                ...
                <stripes:select readonly="true" name="customer.id.document.types"  id="customer.document.id.types" style="display:none">
                    <stripes:option value=""></stripes:option>
                    <stripes:option value="${actionBean.customer.identityNumberType}">
                        <fmt:message   key="document.type.${actionBean.customer.identityNumberType}" />
                    </stripes:option>
                ...
                <table class="clear">
                    ...
                    <c:if test="${s:getPropertyWithDefault('env.customer.kycstatus.display', false)}">
                        <tr style="display:none">
                            ...
                            <td>
                                ...
                                <stripes:select readonly="true" name="customer.KYCStatus">
                    ...
                    <tr style="display:none">
                        <td>Title:</td>
                        <td>
                            <stripes:select readonly="true" name="customer.title">
                                <stripes:option value=""></stripes:option>                                                                   
                    ...
                    <tr style="display:none">
                        ...
                        <td><stripes:text  type="hidden" readonly="true" name="customer.firstName"    id="customer.firstName"  maxlength="50" size="20"/></td>
                    </tr>
                    <tr style="display:none">
                        <td><stripes:label for="middle.name"/>:</td>
                        <c:set var="defaultRule" value="validate(this,'^.{2,50}$','emptyok')"/>
                        <td><stripes:text  type="hidden" readonly="true" name="customer.middleName" id="customer.middleName" maxlength="50" size="20"/></td>
                    </tr>
                    <tr style="display:none">
                        <td><stripes:label for="last.name" />:</td>
                        <c:set var="defaultRule" value="validate(this,'^.{2,50}$','emptynotok')"/>
                        <td><stripes:text  type="hidden" readonly="true" name="customer.lastName" id="customer.lastName" maxlength="50" size="20"/></td>
                    </tr>
                    <tr style="display:none">
                        <td><stripes:label for="gender"/>:</td>
                        <td>
                            <stripes:select readonly="true" name="customer.gender"  id="customer.gender" >
                                <stripes:option value=""></stripes:option>
                    ...
                    <tr style="display:none">
                        ...
                        <td>
                            <c:set var="defaultRule" value="validate(this,'^.{2,50}$','emptyok')"/>
                            <stripes:text  type="hidden" readonly="true" name="customer.mothersMaidenName" value="${actionBean.customer.mothersMaidenName}" maxlength="50" size="20" />
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td><stripes:label for="ssoidentity"/>:</td>
                        <td><stripes:text  type="hidden" readonly="true" name="customer.SSOIdentity" maxlength="50" size="20"/></td>
                    </tr>
                    <c:choose>
                        <c:when test="${customerClassType == 'minor'}">
                            <!--Do nothing -->
                            ...
                            <tr style="display:none">
                                ...
                                <td>
                                    <stripes:text  type="hidden" name="customer.dateOfBirth" readonly="true" id="datePicker1" size="10" maxlength="10" />
                                </td>
                            </tr>
                        </c:when>
                        <c:otherwise>
                            <tr style="display:none">
                                ...
                                <td>
                                    <stripes:text  type="hidden" name="customer.dateOfBirth" readonly="false" id="datePicker1" size="10" maxlength="10" />
                                </td>
                            </tr>
                            ...
                            <tr style="display:none">
                                ...
                                <td>
                                    <stripes:select readonly="true" name="customer.nationality" id="customer.nationality">
                                        <stripes:option value=""></stripes:option>
                                ...
                                <td>
                                    ...
                                    <c:choose>
                                        <c:when test="${s:getProperty('env.customer.id.optional')}">
                                            ...
                                            <stripes:select readonly="true" name="selIdentityType" id="selIdentityType">   
                                                <stripes:option value=""></stripes:option>
                            ...
                            <tr style="display:none">
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${s:getProperty('env.customer.id.optional')}">
                                            <stripes:text  type="hidden" readonly="true" name="customer.identityNumber" id="customer.identityNumber" maxlength="50" size="20"  />
                                        </c:when>
                                        <c:otherwise>
                                            <stripes:text  type="hidden" readonly="true" name="customer.identityNumber" id="customer.identityNumber" maxlength="50" size="20"  />
                                        </c:otherwise>
                        ...
                        <c:if test="${s:getProperty('env.customer.national.id.mandatory')}">
                            <tr>
                                ...
                                <td>
                                    <stripes:text  name="customer.nationalIdentityNumber" id="customer.nationalIdentityNumber" numeric="true" maxlength="11" size="20" onkeypress="return isNumberKey(event)" onkeyup="validate(this,'^.{11,11}$','emptynotok')"/>
                                </td>
                            </tr>
                        </c:if>
                            <c:choose>
                                <c:when test="${s:getProperty('env.customer.verify.with.nira') and actionBean.displayCardNumberField}">
                                    ...
                                    <tr id="idCardNumberRow" style="display:none">
                                        <td><stripes:label for="id.card.number"/>:</td>
                                        <td><stripes:text  type="hidden" readonly="true" name="customer.cardNumber"  id="customer.cardNumber" maxlength="50" size="20" /> </td>
                                     </tr>
                                    </c:when>
                                <c:otherwise>
                                </c:otherwise>    
                            </c:choose>
                            <tr id="passportExpiryDateRow" style="display:none">
                                <td><stripes:label for="passport.expiry.date"/>:</td>
                                <td><stripes:text type="hidden" id="datePicker2" name="customer.passportExpiryDate" maxlength="10" size="10" readonly="true"/></td>
                            </tr>
                            <c:if test="${actionBean.customer.nationality != countryCode}"> 
                                ...
                                <c:if test="${s:getProperty('env.customer.visa.enabled')}">
                                    <tr id="visaExpiryDateRow" style="display:none">
                                        <td><stripes:label for="visa.expiry.date"/>:</td>
                                        <td><stripes:text id="datePicker3" name="customer.visaExpiryDate" maxlength="10" size="10" readonly="true"/></td>
                                    </tr>
                    ...
                    <tr style="display:none">
                        ...
                        <td>
                            <stripes:select name="customer.language" readonly="true">
                    ...
                    <tr style="display:none">
                        ...
                        <td><stripes:text  type="hidden" name="customer.emailAddress" maxlength="200" size="50" readonly="true" /></td>
                     </tr>                
                    <tr style="display:none">
                        ...
                        <td><stripes:text  type="hidden" name="customer.alternativeContact1" id="customer.alternativeContact1" maxlength="15" size='15' readonly="true" /></td>
                    </tr>
                    <tr style="display:none">
                         <!--<c:set var="defaultRule" value="validate(this, '^[+()0-9 -]{5,15}$','emptyok')"/> -->
                        <td><stripes:label for="alternative.contact.number.2"/>:</td>
                        <td><stripes:text  type="hidden" name="customer.alternativeContact2" maxlength="15" size="15" readonly="true"/></td>
                    </tr>

                    <tr style="display:none">
                        <td><stripes:label for="opt.in.level"/>:</td>
                        <td>
                            <stripes:select name="customer.optInLevel" readonly="true">
                    ...
                    <tr style="display:none">
                        ...
                        <td><stripes:text  type="hidden" name="customer.warehouseId" maxlength="15" size="15" readonly="true"/></td>
                    </tr>

                    <tr>
                        <td colspan="2">
                            <span class="button">                                
                                <stripes:submit name="updateCustomerNIN" onclick="onUpdate=true;"/>
                        </td>
                    </tr> 
                </table>                
            </stripes:form>
