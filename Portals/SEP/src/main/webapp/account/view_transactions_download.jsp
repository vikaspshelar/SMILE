        ...
        <div id="entity">
            ...
            <stripes:form action="/Account.action" focus="" name="frm">
                ...
                <table class="clear">
                    ...
                    <tr>
                        <td colspan="2">
                            <span class="button">
                                <stripes:submit name="retrieveTPGWTransactionHistoryDownload"/>
                            </span>                        
                        </td>
                    </tr>                    
                </table>            
            ...
            <c:if test="${!empty actionBean.accountHistory.transactionRecords}">
                ...
                <stripes:form action="/Account.action">
                    ...
                    <input type="hidden" name="action" value="retrieveTPGWTransactionHistoryDownload"/>
                ...
                <stripes:form action="/Account.action">    
                    ...
                    <stripes:submit name="retrieveTransactionHistoryPrintableTPGW"/>
                </stripes:form>
