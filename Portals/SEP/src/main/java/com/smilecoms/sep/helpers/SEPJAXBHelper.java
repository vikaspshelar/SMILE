...
import com.smilecoms.sep.helpers.ext.tnf.AttributionResponse;
import com.smilecoms.sep.helpers.ext.tnf.ComplexResponse;
import com.smilecoms.sep.helpers.ext.tnf.MetricResponse;
 ...
 * @author sabza
 */
public class SEPJAXBHelper {
    private static final Logger log = LoggerFactory.getLogger(SEPJAXBHelper.class);
