 ...
 * @author sabza
 */
public class AccessBankTransactionData extends AbstractTransactionData {

    public AccessBankTransactionData(Sale sale, String itemDescription) {
        super(sale, itemDescription);
        this.paymentGatewayPostURL = BaseUtils.getSubProperty("env.pgw.access.config", "PaymentGatewayPostURL");
    }
