                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach items="${prodInstance.productServiceInstanceMappings}" var="mapping" varStatus="loop">
                            <c:forEach items="${actionBean.customer.serviceInstances}" var="serviceInstance" varStatus="loop2">
                                <c:if test="${mapping.serviceInstance.serviceInstanceId eq serviceInstance.serviceInstanceId}">
