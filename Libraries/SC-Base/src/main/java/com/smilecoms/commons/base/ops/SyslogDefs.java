...
public class SyslogDefs {
    ...
    static private final HashMap<String,Integer> facHash;
    static private final HashMap<String,Integer> priHash;
    

    static {
        facHash = new HashMap<String,Integer>(20);
        ...
        priHash = new HashMap<String,Integer>(20);
    ...
    static public int getPriority(String priority)
            throws ParseException {
        String priKey = priority.toUpperCase();
        Integer result = (Integer) SyslogDefs.priHash.get(priKey);
