...
public class SIPClientTransactionImpl extends SIPTransactionImpl implements SIPClientTransaction {
   ...
   //     ref.add(new WeakReference(this));

//        if (System.currentTimeMillis() - t > 30000) {
//            t = System.currentTimeMillis();
//
//            for (WeakReference<SIPClientTransactionImpl> wr : ref) {
//                if (wr.isEnqueued()) {
//                    ref.remove(wr);
//                } else {
//                    if (wr.get() != null && System.currentTimeMillis() - wr.get().created > 30000) {
//                        logger.logDebug("Old: " + wr.get());
//                    }
//                }
//            }
//
...
//    private static final Set<WeakReference<SIPClientTransactionImpl>> ref = new java.util.concurrent.CopyOnWriteArraySet<>();
//    private static long t = System.currentTimeMillis();

    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#setResponseInterface(gov.nist.javax.sip.stack.ServerResponseInterface)
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#isMessagePartOfTransaction(gov.nist.javax.sip.message.SIPMessage)
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#sendMessage(gov.nist.javax.sip.message.SIPMessage)
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#processResponse(gov.nist.javax.sip.message.SIPResponse,
   ...
   * Note that this is different from an ACK for 2xx
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#setViaHost(java.lang.String)
     */
    @Override
   ...
   * @see javax.sip.Transaction#terminate()
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#checkFromTag(gov.nist.javax.sip.message.SIPResponse)
     */
    @Override
    ...
    public String toString() {
        return "SIPClientTransactionImpl: " + UUID;
    }
   ...
   * gov.nist.javax.sip.message.SIPMessage)
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#getDialog(java.lang.String)
     */
    @Override
   ...
   * gov.nist.javax.sip.message.SIPMessage)
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#setDialog(gov.nist.javax.sip.stack.SIPDialog,
     * java.lang.String)
     */
    @Override
    public void setDialog(SIPDialog sipDialog, String dialogId) {
        ...
        if (this.defaultDialog == null && defaultDialogId == null) {
            ...
            if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
                logger.logDebug("setDialog: " + dialogId + " sipDialog = " + sipDialog + " as defaultDialog");
            }
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#setNextHop(javax.sip.address.Hop)
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#setNotifyOnRetransmit(boolean)
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#alertIfStillInCallingStateBy(int)
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#getOriginalRequestFromTag()
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#getOriginalRequestCallId()
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#getOriginalRequestEvent()
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#getOriginalRequestContact()
     */
    @Override
    ...
    /**
     * @see
     * gov.nist.javax.sip.stack.SIPClientTransaction#getOriginalRequestScheme()
     */
    @Override
