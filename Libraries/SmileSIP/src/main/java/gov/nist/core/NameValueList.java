 ...
 * hash map) the default behavior for this class is not thread safe. specify a
 * constructor with boolean true to make this thread safe.
 *
 * @version 1.2
 *
...
//    private static final Map<WeakReference<NameValueList>, Exception> instances = new HashMap<>();
//    private static final Logger log = LoggerFactory.getLogger(NameValueList.class);
...
//                    try {
//                        Thread.sleep(30000);
//                        log.error("In NameValueList instance thread");
//                        for (Entry<WeakReference<NameValueList>, Exception> ent : instances.entrySet()) {
//                            NameValueList inst = ent.getKey().get();
//                            if (inst != null) {
//                                long age = System.currentTimeMillis() - inst.created;
//                                if (age > 60000) {
//                                    Exception e = ent.getValue();
//                                    log.error("Here is an old instance created " + age / 1000 + "s ago. [{}]",inst.hmap, e);
//                                }
//                            }
//                        }
//                    } catch (Exception e) {
...
//        instances.put(new WeakReference(this), new Exception());
